...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.dateTimeEdit.dateTimeChanged.connect(self.dateTimeChange)  # TODO подключить слот для вывода датывремени в plainTextEditLog при изменении датывремени в dateTimeEdit
    ...
    def dateTimeChange(self):
        currentdatetime = self.dateTimeEdit.dateTime()
        self.plainTextEditLog.setPlainText(currentdatetime.toString("dd.MM.yyyy hh:mm"))
