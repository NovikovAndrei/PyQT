...
class Ui_LoginForm(object):
    def setupUi(self, LoginForm):
        ...
        self.verticalSpacer = QSpacerItem(20, 57, QSizePolicy.Minimum, QSizePolicy.Expanding)
    ...
    def retranslateUi(self, LoginForm):
        ...
        self.pushButtonOk.setText(QCoreApplication.translate("LoginForm", u"Ok", None))
